...
//	private RunnerViewHistory fViewHistory;
	...
	private class TestSessionListener implements ITestSessionListener {
		...
		public void sessionStarted() {
			...
			fEditLaunchConfigAction.setEnabled(fTestRunSession.getLaunchConfiguration() != null);
		}
	...
	private class RerunLastAction extends Action {
		...
		@Override
		public void run() {
			DebugUITools.launch(fTestRunSession.getLaunchConfiguration(), rerunLaunchMode());
		}
	}
...
//		}
	...
	public TestRunSession setActiveTestRunSession(TestRunSession testRunSession) {
		...
		if (testRunSession == null) {
			...
			updateRerunFailedFirstAction();
			fRerunLastTestAction.setEnabled(fTestRunSession.getLaunchConfiguration() != null);
			fEditLaunchConfigAction.setEnabled(fTestRunSession.getLaunchConfiguration() != null);
	...
	private void updateRerunFailedFirstAction() {
		boolean state = hasErrorsOrFailures() && fTestRunSession.getLaunchConfiguration() != null;
	...
	private void configureToolBar() {
		...
		fEditLaunchConfigAction = new EditLaunchConfigurationAction() {
			...
			protected ILaunchConfiguration getLaunchConfiguration() {
				return fTestRunSession != null ? fTestRunSession.getLaunchConfiguration() : null;
			}
